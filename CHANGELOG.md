...
**Build V22 (2026-07-29 09:14, commit `eee30fc`):** generado con
...
`dist\DEFYVISION_METALCONF_V22_CYTHON_2026-07-29.zip` (136.7 MB), tag `V22`.
Este build ya NO tiene el bug; el V21 y anteriores si.
